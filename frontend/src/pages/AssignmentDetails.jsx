...
const AssignmentDetails = () => {
      ...
      try {
        ...
        setError(
          error.response?.data?.message ||
            "An error occurred while loading the assignment.",
        );
      } finally {
        setLoading(false);
      }
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setSubmitError(
        error.response?.data?.message ||
          "An error occurred while submitting your assignment.",
      );
    } finally {
      setSubmitting(false);
    }
      ...
      {submission ? (
        <div className="submission-section">
          ...
          {submission.score !== undefined && submission.score !== null && (
            <p>
              <strong>Score:</strong> {submission.score} / {assignment.maxScore}
            </p>
          )}
          {submission.feedback && (
            <p>
